...
<main>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <p class="lead">Generasi hebat, Generasi tangguh Jaya Jaya Jaya!</p>
            ...
            <div class="col-lg-12">
                <div class="row align-items-center phone-ver">
                    <div class="col-md">
                        ...
                        <p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dui suscipit mi quis blandit sodales. Praesent faucibus magna libero, vel tempus arcu bibendum quis. Vestibulum entum nibh a dolor efficitur ultrices. Nulla in sollicitudin massa. Aliq posuere enim id eros ullamcorper, eu consectetur tellus fla. Mauris gravida id dolor ac euismod. Nunc id facilisis tellus, sed dapibus nisl. Sed a eros sed justo malesuada varius. </p>
                    </div>
