                ...
                <div class="card-body">
                    ...
                    <div class="row m-b-30">
                        <div class="col-12 d-flex justify-content-end p-h-30">
                            <div class="row">
                                <a href="<?= base_url('/admin/donatur/add') ?>" class="btn btn-santri btn-hover-santri">Tambah Donatur</a>
                            </div>
                        </div>
                    </div>
                    <div class="m-t-10">
                        <div class="table-responsive">
                            <table id="data-table" class="table table-hover table-borderless">
                                ...
                                <tbody>
                                    <?php $i = 1 ?>
                                    <?php foreach ($dataDonatur as $data) : ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
                                            <td><?= $data['nama'] ?></td>
                                            <td><?= $data['no_hp'] ?></td>
                                            <td><?= $data['Alamat'] ?></td>
                                            <td>
                                                <a class="btn btn-icon btn-hover btn-sm btn-rounded" href="<?= base_url('/admin/donatur/' . $data['id'] . '/view') ?>">
                                                    <i class="anticon anticon-eye" style="color: #336CFB;"></i>
                                                </a>
                                                <a class="btn btn-icon btn-hover btn-sm btn-rounded" href="<?= base_url('/admin/donatur/' . $data['id'] . '/edit') ?>">
