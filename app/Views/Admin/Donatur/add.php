        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="<?= base_url('/admin/donatur/add') ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="form-group">
                            <label>Nama Donatur</label>
                            <input type="text" name="nama" class="form-control <?= (isset($validation)) ? ($validation->hasError('nama')) ? 'is-invalid' : null : null ?>" placeholder="ex: Uswanto" value="<?= set_value('nama') ?>">
