                                    ...
                                    <?php if (isset($validation)) : ?>
                                        <div class="col-12 mb-2">
                                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                <b>Gagal&nbsp;</b>melakukan pendaftaran, mohon mengisi form dengan benar!
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="pills-santri" role="tabpanel" aria-labelledby="pills-santri-tab">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="no_santri" class="form-control <?= (isset($validation)) ? ($validation->hasError('no_santri')) ? 'is-invalid' : null : null ?>" placeholder="ex: 081234567890" value="<?= set_value('no_hp_santri') ?>">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                <label>Hobi</label>
                                                <input type="text" name="hobi" class="form-control <?= (isset($validation)) ? ($validation->hasError('hobi')) ? 'is-invalid' : null : null ?>" placeholder="ex: Sepak Bola" value="<?= set_value('hobi_santri') ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="tab-pane fade" id="pills-ayah" role="tabpanel" aria-labelledby="pills-ayah-tab">
                                            ...
                                            <div class="form-group">
                                                <label>NIK</label>
                                                <input type="number" name="nik_ayah" class="form-control <?= (isset($validation)) ? ($validation->hasError('nik_ayah')) ? 'is-invalid' : null : null ?>" placeholder="ex: 190645234" value="<?= set_value('nik_santri') ?>">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                <label>No Handphone</label>
                                                <input type="number" name="no_ayah" class="form-control <?= (isset($validation)) ? ($validation->hasError('no_ayah')) ? 'is-invalid' : null : null ?>" placeholder="ex: 081234567890" value="<?= set_value('no_hp_ayah') ?>">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="tab-pane fade" id="pills-ibu" role="tabpanel" aria-labelledby="pills-ibu-tab">
                                            ...
                                            <div class="form-group">
                                                <label>No Handphone</label>
                                                <input type="number" name="no_ibu" class="form-control <?= (isset($validation)) ? ($validation->hasError('no_ibu')) ? 'is-invalid' : null : null ?>" placeholder="ex: 081234567890" value="<?= set_value('no_hp_ibu') ?>">
                                                <div class="invalid-feedback">
