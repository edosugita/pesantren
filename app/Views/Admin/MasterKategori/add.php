        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <div class="m-t-10">
                        <form action="<?= base_url('/admin/master/kategori/add') ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control <?= (isset($validation)) ? ($validation->hasError('name')) ? 'is-invalid' : null : null ?>" placeholder="ex: Hadist" name="name" value="<?= set_value('name') ?>">
