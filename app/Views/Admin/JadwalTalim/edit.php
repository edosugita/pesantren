                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?= base_url('/admin/jadwal-talim/' . $dataJadwal['id'] . '/edit') ?>" onsubmit="return confirm('Anda yakin ingin merubah data ini?');">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="materi" class="form-control  <?= (isset($validation)) ? ($validation->hasError('materi')) ? 'is-invalid' : null : null ?>" placeholder="ex: Hadist" value="<?= $dataJadwal['materi'] ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_kitab" class="form-control  <?= (isset($validation)) ? ($validation->hasError('nama_kitab')) ? 'is-invalid' : null : null ?>" placeholder="ex: Hadist" value="<?= $dataJadwal['nama_kitab'] ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" class="select2  <?= (isset($validation)) ? ($validation->hasError('kategori')) ? 'is-invalid' : null : null ?>">
                                <?php foreach ($dataKategori as $data) : ?>
                                    <option value="<?= $data['nama'] ?>" <?= $data['id'] == $dataJadwal['id_kategori'] ? 'selected' : '' ?>><?= $data['nama'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-affix m-b-10">
                                ...
                                <input type="text" name="tgl_jadwal" class="form-control  <?= (isset($validation)) ? ($validation->hasError('tgl_jadwal')) ? 'is-invalid' : null : null ?> datepicker-input" placeholder="ex: 06/14/2022" readonly style="background: white;" value="<?= date('m/d/Y', strtotime(str_replace("-", "/", $dataJadwal['tgl_jadwal']))) ?>">
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2" name="hari">
                                <option value="Senin" <?= 'Senin' == $dataJadwal['hari'] ? 'selected' : '' ?>>Senin</option>
                                <option value="Selasa" <?= 'Selasa' == $dataJadwal['hari'] ? 'selected' : '' ?>>Selasa</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2" name="waktu">
                                <option value="05.30 - 06.30" <?= '05.30 - 06.30' == $dataJadwal['waktu'] ? 'selected' : '' ?>>05.30 - 06.30</option>
                                <option value="11.00 - 12.00" <?= '11.00 - 12.00' == $dataJadwal['waktu'] ? 'selected' : '' ?>>11.00 - 12.00</option>
                                <option value="14.30 - 15.30" <?= '14.30 - 15.30' == $dataJadwal['waktu'] ? 'selected' : '' ?>>14.30 - 15.30</option>
                                <option value="17.00 - 18.00" <?= '17.00 - 18.00' == $dataJadwal['waktu'] ? 'selected' : '' ?>>17.00 - 18.00</option>
                                <option value="19.00 - 20.00" <?= '19.00 - 20.00' == $dataJadwal['waktu'] ? 'selected' : '' ?>>19.00 - 20.00</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="lokasi" class="form-control <?= (isset($validation)) ? ($validation->hasError('lokasi')) ? 'is-invalid' : null : null ?>" placeholder="ex: Masjid" value="<?= $dataJadwal['tempat'] ?>">
                        </div>
                        <div class="row">
