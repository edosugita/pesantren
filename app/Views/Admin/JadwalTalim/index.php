            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5>Jadwal Ta’lim</h5>
                        <a class="btn btn-santri btn-hover-santri" href="<?= base_url('/admin/jadwal-talim/cetak') ?>"><i class="anticon anticon-printer m-r-15"></i>Cetak</a>
                    </div>
                    <hr>
                    <!-- START ALERT -->
                    ...
                    <div class="row m-b-30">
                        <div class="col-12 d-flex justify-content-end p-h-30">
                            <div class="row">
                                <a class="btn btn-santri btn-hover-santri" href="<?= base_url('/admin/jadwal-talim/add') ?>">Tambah Jadwal</a>
                            </div>
                        </div>
                    </div>
                    <div class="m-t-10">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($dataKategori as $data) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-icon btn-hover btn-sm btn-rounded" href="<?= base_url('/admin/jadwal-talim/' . $data['id'] . '/edit') ?>">
                                        ...
                                        <div class="modal fade" id="delete">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content" style="border-radius: 12px; overflow:hidden;">
                                                    ...
                                                    <form action="<?= base_url('/admin/jadwal-talim/delete/' . $data['id']) ?>" method="post">
