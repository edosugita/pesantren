                ...
                <div class="card-body">
                    ...
                    <div class="row m-b-30">
                        <div class="col-12 d-flex justify-content-end p-h-30">
                            <div class="row">
                                <a class="btn btn-santri btn-hover-santri" href="<?= base_url('/admin/master/kode-surat/add') ?>">Tambah Kop</a>
                            </div>
                        </div>
                    </div>
                    <div class="m-t-10">
                        <div class="table-responsive">
                            <table id="data-table" class="table table-hover table-borderless">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($dataKop as $data) : ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
                                            <td><?= $data['nama'] ?></td>
                                            <td>
                                                <a class="btn btn-icon btn-hover btn-sm btn-rounded" href="<?= base_url('/admin/master/kode-surat/' . $data['id'] . '/edit') ?>">
                                                ...
                                                <div class="modal fade" id="delete">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content" style="border-radius: 12px; overflow:hidden;">
                                                            ...
                                                            <form action="<?= base_url('/admin/master/kode-surat/delete/' . $data['id']) ?>" method="post">
